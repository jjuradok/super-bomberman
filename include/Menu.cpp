...
Menu::Menu() {
    ...
    m_t5.setFont(m_font);  m_t5.setString("Settings"); m_t5.setCharacterSize(70); m_t5.setPosition(180,450);
    m_t4.setFont(m_font);  m_t4.setString("Jurado-Lui. 2024"); m_t4.setCharacterSize(70); m_t4.setPosition(180,900);
    m_options.push_back(m_t2); m_options.push_back(m_t3); m_options.push_back(m_t5);
}
...
void Menu::update(Game &j) {
    ...
    if (sf::Mouse::isButtonPressed(sf::Mouse::Left)){
        ...
        if(m_t5.getGlobalBounds().contains(static_cast<float>(sf::Mouse::getPosition(j.getWindow()).x), static_cast<float>(sf::Mouse::getPosition(j.getWindow()).y))) {
